/**
 *Submitted for verification at Arbiscan.io on 2022-08-16
*/

pragma solidity ^0.8.19; // optimization enabled, 99999 runs, evm: petersburg
...
contract ImmutableCreate2Factory {
   ...
   * @return deploymentAddress address Address of the contract that will be created, or the null address
